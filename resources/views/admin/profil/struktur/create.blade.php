<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            <div class="overflow-hidden group shadow-sm sm:rounded-lg hover:shadow-md transition-shadow bg-white p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    {{-- <a href="{{ route('admin.profil.index') }}" class="text-sm text-gray-500 hover:underline">Batal</a> --}}
                </div>
                ...
                <form action="{{ route('admin.profil.struktur.create', $struktur->id ?? '') }}" 
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea id="deskripsi" name="deskripsi" rows="6"
                                      class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-gray-700"
                                      placeholder="Contoh: Struktur organisasi terdiri dari Kepala Pusat, Sekretaris, Koordinator Program (Penelitian, Pengabdian, Publikasi), serta Divisi Dokumentasi & Arsip.">
                                {{ old('deskripsi', $struktur->deskripsi ?? '') }}
                            </textarea>
                        </div>
                        @error('deskripsi')
                    ...
                    <div x-data="{ preview: null }">
                        ...
                        {{-- Preview instan saat pilih file baru --}}
                    ...
                    {{-- Alt text (opsional, bagus untuk aksesibilitas/SEO) --}}
                    <div>
    ...
    {{-- AlpineJS untuk preview (jika belum ada di app.js) --}}
    @push('scripts')
