<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white shadow-sm sm:rounded-lg p-6">
        ...
        <div class="overflow-x-auto" data-theme="light">
            <x-datatable id="table-mitra" order='[5,"asc"]' :page-length="10" :buttons="true">
                <thead>
                <tr>
                    <th>Logo</th>
                    <th>Nama</th>
  ...
  @push('head')
    ...
    #table-mitra th, #table-mitra td { vertical-align: middle !important; }
    /* Kolom logo fix width */
    #table-mitra th:nth-child(1), #table-mitra td:nth-child(1) { width: 56px; text-align:start; }
    /* Center kolom Status, Urutan, Beranda, Website, Aksi */
    #table-mitra th:nth-child(5),
    #table-mitra th:nth-child(6),
    #table-mitra th:nth-child(7),
    #table-mitra th:nth-child(8),
    #table-mitra th:nth-child(9),
    #table-mitra td:nth-child(5),
    #table-mitra td:nth-child(6),
    #table-mitra td:nth-child(7),
    #table-mitra td:nth-child(8),
    #table-mitra td:nth-child(9) { text-align: start; }
    </style>
    @endpush
