    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="overflow-hidden group shadow-sm sm:rounded-lg hover:shadow-md transition-shadow bg-white p-6">
        <div class="flex items-center justify-between mb-4">
          <p class="font-semibold text-zinc-900 text-lg">Form Kebijakan & Tata Kelola</p>
        </div>
        ...
        <form action="{{ route('admin.profil.kebijakan.create') }}"
          ...
          <div class="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <input id="judul" name="judul" type="text"
                     ...
                     value="{{ old('judul', $kebijakan->judul ?? '') }}" placeholder="Contoh: Kebijakan Pengelolaan Arsip Digital"/>
            ...
            <div>
              ...
              <select id="kategori" name="kategori"
                      class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                @php $kategoriOld = old('kategori', $kebijakan->kategori ?? 'Kebijakan'); @endphp
            ...
            <div>
              ...
              <input id="nomor_dokumen" name="nomor_dokumen" type="text"
                     class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                     value="{{ old('nomor_dokumen', $kebijakan->nomor_dokumen ?? '') }}" placeholder="Contoh: 001/Kebijakan/PSBSD/2025"/>
            ...
            <div>
              ...
              <input id="versi" name="versi" type="text"
                     class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                     value="{{ old('versi', $kebijakan->versi ?? '1.0') }}" placeholder="1.0"/>
          ...
          <div>
            ...
            {{-- Catatan: ganti textarea ini dengan editor (Trix/Quill/TinyMCE) kalau perlu WYSIWYG --}}
          </div>
          ...
          <div class="grid md:grid-cols-3 gap-6">
            <div>
              ...
              <input id="otoritas_pengesah" name="otoritas_pengesah" type="text"
                     class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                     value="{{ old('otoritas_pengesah', $kebijakan->otoritas_pengesah ?? '') }}" placeholder="Kepala Pusat / Dekan / Rektor"/>
            ...
            <div>
              ...
              <input id="penanggung_jawab" name="penanggung_jawab" type="text"
                     class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                     value="{{ old('penanggung_jawab', $kebijakan->penanggung_jawab ?? '') }}" placeholder="Sekretaris / Koordinator Tata Kelola"/>
            ...
            <div>
              ...
              <input id="unit_terkait" name="unit_terkait" type="text"
                     class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                     value="{{ old('unit_terkait', $kebijakan->unit_terkait ?? '') }}" placeholder="Dokumentasi & Arsip; Program; Keuangan"/>
          ...
          <div class="grid md:grid-cols-3 gap-6">
            <div>
              ...
              <input id="tanggal_berlaku" name="tanggal_berlaku" type="date"
                     class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                     value="{{ old('tanggal_berlaku', optional($kebijakan->tanggal_berlaku ?? null)->format('Y-m-d')) }}">
            ...
            <div>
              ...
              <input id="tanggal_tinjau_berikutnya" name="tanggal_tinjau_berikutnya" type="date"
                     class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                     value="{{ old('tanggal_tinjau_berikutnya', optional($kebijakan->tanggal_tinjau_berikutnya ?? null)->format('Y-m-d')) }}">
            ...
            <div>
              ...
              @php $siklusOld = old('siklus_tinjau', $kebijakan->siklus_tinjau ?? 'Tahunan'); @endphp
          ...
          <div class="grid md:grid-cols-2 gap-6">
            <div>
              ...
              @php $statusOld = old('status', $kebijakan->status ?? 'Draft'); @endphp
            ...
            <div>
              ...
              <input id="tags" name="tags" type="text"
                     class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                     value="{{ old('tags', $kebijakan->tags ?? '') }}" placeholder="kebijakan, tata kelola, arsip, SOP"/>
